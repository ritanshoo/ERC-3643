...
contract('Token', (accounts) => {
    ...
    beforeEach(async () => {
        ...
        // console.log(trustedIssuersRegistry.address, claimTopicsRegistry.address)
        ...
        const { _identityRegistry, _compliance, _name, _symbol, _decimals, _onchainID } = data
        /**
         * 
        ...
        let tx = await token.init(_identityRegistry, _compliance, _name, _symbol, _decimals, _onchainID, { from: tokeny });
        // console.log(tx)
    ...
    it('decimals returns the number of decimals of the token', async () => {
        ...
        // console.log({ decimals1:decimals1.toString() })
    ...
    it('version returns the version of the token', async () => {
        ...
        // console.log({ version1:version1.toString() })
    ...
    it('onchainID returns the onchainID address of the token', async () => {
        ...
        // console.log({ onchainID1:onchainID1.toString() })
